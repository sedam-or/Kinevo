...
<template>
    <ul v-if="reasons.length > 0" class="text-xs text-text-muted space-y-1" data-testid="scheduler-explanation">
    ...
    <p v-else class="text-xs text-text-muted" data-testid="scheduler-explanation-empty">
