...
use App\Infrastructure\Ai\EloquentAiCostAlertRepository;
...
use App\Infrastructure\Ai\EloquentUserAiProviderConfigRepository;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->singleton(AiCostAlertRepository::class, EloquentAiCostAlertRepository::class);
        $this->app->singleton(UserAiProviderConfigRepository::class, EloquentUserAiProviderConfigRepository::class);
